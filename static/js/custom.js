...
$(document).ready(function() {
    "use strict";
    if ($(window).width() > 800) {
        $('#ascensorFloor1').backstretch("images/slide3.jpg");
        $('#ascensorFloor2').backstretch("images/slide4.jpg");
        $('#ascensorFloor3').backstretch("images/slide5.jpg");
    }
    //// FOR SMALL MOBILE DEVICES ////
    else {
        $('#ascensorFloor1').backstretch("images/m-slide3.jpg");
        $('#ascensorFloor2').backstretch("images/m-slide4.jpg");
        $('#ascensorFloor3').backstretch("images/m-slide5.jpg");
    }
});
